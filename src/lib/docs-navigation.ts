...
export const DOC_NAVIGATION: DocCategory[] = [
  ...
  },
  {
    ...
    pages: [
      { slug: "intrebari-contabil-mai-2026", title: "Intrebari pentru contabil — mai 2026", description: "Doua intrebari concrete dupa alinierea catalogului la OMFP 1802 oficial: formula TVA in starea pre-close si statutul contului 4373", interactive: true },
