...
- (a) Un regim nou `transition` care permite ambele conturi?
- (b) Setarea regimului sa fie **per luna** (si noi sa detectam automat care cont e activ)?
- (c) Lasam ca e si utilizatorul seteaza regimul pe care il doreste la momentul respectiv; diferentele raman manuale?

Pentru moment am ales (c). Dubiu care ramane: pe declaratia anuala F20 se depune **un singur rand 34** cu totalul; deci probabil (a) este solutia cea mai apropiata de realitate.
